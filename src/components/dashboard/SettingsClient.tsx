        ...
        <div className="space-y-6">
          ...
          <div className="border-4 border-white bg-white p-6">
            ...
            <button
              ...
              className="w-full border-4 border-[#0A0A0A] bg-transparent text-[#0A0A0A] font-mono px-6 py-3 text-sm uppercase font-bold hover:bg-[#0A0A0A] hover:text-white transition-all duration-100 flex items-center justify-center gap-2 hover:shadow-none"
          ...
          <div className="flex justify-end gap-4 pt-4">
            <button
              ...
              disabled={saving}
              className="border-4 border-gray-500 bg-transparent text-gray-700 font-mono px-6 py-3 text-sm uppercase font-bold hover:bg-gray-500 hover:text-white hover:shadow-none transition-all duration-100 disabled:opacity-50"
            ...
            <button
              ...
              disabled={saving}
              className="border-4 border-[#39FF14] bg-transparent text-[#39FF14] font-mono px-8 py-3 text-sm uppercase font-bold hover:bg-[#39FF14] hover:text-[#0A0A0A] hover:shadow-none transition-all duration-100 disabled:opacity-50 flex items-center gap-2"
