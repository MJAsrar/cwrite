...
const dialogContentVariants = cva(
  "fixed left-[50%] top-[50%] z-50 grid w-full translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-scale-in data-[state=closed]:animate-scale-out sm:rounded-lg",
  {
    variants: {
      size: {
        sm: "max-w-sm",
...
// Enhanced Modal component for backward compatibility
